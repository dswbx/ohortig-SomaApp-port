...
const WeeklyMissionsWidget: React.FC<WeeklyMissionWidgetProps> = ({
   dashboardData,
}) => {
   return (
         ...
         >
            <View style={{ flexDirection: "column" }}>
               <View style={styles.missionContainer}>
                  ...
                  />
                  <Pressable
                     style={styles.missionStartNowButton}
                     onPress={() => alert("Feature coming soon")}
                  >
                     <Text style={{ color: "white" }}>Start Now</Text>
                  </Pressable>
               </View>
               <Text style={{ marginTop: 5, color: "#2E3339", fontSize: 14 }}>
                  {dashboardData.quizzes[0].title}
               </Text>
